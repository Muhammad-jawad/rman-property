 ...
 */
class Ma_Rman_Properties_Loader {
     ...
     *
     * @since    1.0.0
     * @param    string   $tag             The name of the shortcode to be registered.
     * @param    object   $component       A reference to the instance of the object on which the shortcode callback is defined.
     * @param    string   $callback        The name of the function definition on the $component that will handle the shortcode.
     */
